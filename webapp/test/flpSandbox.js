		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zcrmsalesdashboard-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcrmsalesdashboard-display": {
								"semanticObject": "zcrmsalesdashboard",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcrmsalesdashboard",
									"url": sap.ui.require.toUrl("zcrmsalesdashboard")
								}
							}
						}
					}
